			...
			<View style={styles.body}>
				...
				<View style={{ backgroundColor: '#222222', marginBottom: 10 }}>
					...
					<View style={styles.description}>
						...
						<Text style={{ color: 'grey', marginHorizontal: 5 }}>Adventure, Drama, Sci-Fi</Text>
					</View>
					...
					<View style={styles.description2}>
						...
						>
							...
							<TouchableOpacity style={styles.bouton} onPress={() => console.log('+ ADD TO WATCHLIST')}>
								<View>
									<Text
										style={{
											color: 'white',
					...
					>
						...
						>
							...
							<Text style={{ color: 'white', fontWeight: 'bold', fontSize: 12 }}>RATE THIS</Text>
						</View>
						<View style={{ flex: 1, alignItems: 'center' }}>
							<View
								style={{
							...
							<Text style={{ fontSize: 12, color: 'grey', height: 20 }}>46 critic reviews</Text>
						</View>
					</View>
				</View>
				...
				<View style={{ backgroundColor: '#222222' }}>
					...
					>
						...
						<Text style={{ fontSize: 15, color: '#3e9ee8', fontWeight: 'bold' }}>SEE ALL</Text>
					</View>
					...
					<ScrollView horizontal={true}>
						...
						<View style={styles.paddingL10}>
							<Image style={styles.image} source={require('./Assets/annehathaway.jpg')} />
							<Text style={styles.textwhite}> Anne Hathaway</Text>
							<Text style={styles.textgrey}> Brand</Text>
						</View>

						<View style={styles.paddingL10}>
							<Image style={styles.image} source={require('./Assets/jessica-chastain.jpg')} />
							<Text style={styles.textwhite}> Jessica Chastain</Text>
							<Text style={styles.textgrey}> Murph</Text>
						</View>

						<View style={styles.paddingL10}>
							<Image style={styles.image} source={require('./Assets/MichaelCaine.jpg')} />
